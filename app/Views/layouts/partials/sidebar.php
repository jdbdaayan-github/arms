    ...
    <div class="sidebar">
        ...
        <nav class="mt-0">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- Dashboard -->
                <li class="nav-item">
                    <a href="<?= base_url('dashboard/' . strtolower(str_replace(' ', '_', session()->get('role')))) ?>"
                ...
                <?php if (hasRole('Superadmin') || hasPermission('roles.view')): ?>
                    <li class="nav-item has-treeview <?= isMenuOpen('roles') ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (hasRole('Superadmin') || hasPermission('roles.create')): ?>
                                <li class="nav-item">
                ...
                <?php if (hasRole('Superadmin') || hasPermission('permissions.view')): ?>
                    <li class="nav-item has-treeview <?= isMenuOpen('permissions') ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php if (hasRole('Superadmin') || hasPermission('permissions.create')): ?>
                                <li class="nav-item">
