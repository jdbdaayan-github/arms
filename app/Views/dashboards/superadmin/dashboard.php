        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-success">
                    ...
                    <a href="<?= base_url('records') ?>" class="small-box-footer">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info">
                    ...
                    <a href="<?= base_url('records/archived') ?>" class="small-box-footer">
                        View Archives <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <h3><?= $recentLogins ?? 12 ?></h3>
                        <p>Recent Logins</p>
                    </div>
                    <div class="icon"><i class="fas fa-sign-in-alt"></i></div>
                    <a href="<?= base_url('logs/logins') ?>" class="small-box-footer">
                        View Logins <i class="fas fa-arrow-circle-right"></i>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <canvas id="recordsPieChart" style="min-height:300px;"></canvas>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?= base_url('users') ?>" class="btn btn-sm btn-primary">
                                View All
                            </a>
                        </div>
                    </div>
