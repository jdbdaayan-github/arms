    ...
    <div class="container-fluid">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-file-alt mr-2"></i>Edit Request
                </h3>
            </div>
                ...
                <form action="<?= base_url('records/updateRequest/'.$request->id) ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            name="description"
                            rows="4"
                            placeholder="Enter any details or description related to your request..." required><?= set_value('description') ?><?= esc($request->description) ?></textarea>
                        ...
                        <select
                            ...
                            <?php foreach ($req_type as $type): ?>
                                <option value="<?= esc($type->id) ?>"
                                    <?= (set_value('request_type')?set_value('request_type'):esc($request->request_id) == $type->id) ? 'selected' : '' ?>>
                                    <?= esc($type->name) ?>
                                </option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            rows="4"
                            name="remarks"
                            placeholder="Enter reason for request..."><?= set_value('remarks') ?><?= esc($request->remarks) ?></textarea>
                    ...
                    <div class="form-group mt-3 d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-success btn-flat">
                            <i class="fas fa-edit mr-1"></i> Update Request
                        </button>
                    </div>
                </form>
            </div>
