...
<script>
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return `
                        ...
                        <button class="btn btn-danger btn-sm attempts-user" data-id="${data}" data-verified="${row.verified}" data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh Attempts">
    ...
    $(document).on('click', '.verify-user', function() {
        ...
        Swal.fire({
            title: "Are you sure?",
            text: `Do you want to reset this user attempts?`,
            icon: "question",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#6c757d",
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    data: { 
                        ...
                        id: userId },
                    success: function(response) {
                        Swal.fire("Success!", "User has been " + response.success + ".", "success");
                        userstable.ajax.reload(null, false);
                    },
                    error: function() {
                        Swal.fire("Error!", "Something went wrong.", "error");
